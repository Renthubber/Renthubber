...
import { Search, SlidersHorizontal, Box, LayoutGrid, MapPin, Euro, Calendar, X, Sparkles, Star } from 'lucide-react';
...
export const Annunci: React.FC<AnnunciProps> = ({ onListingClick, listings, bookings = [], currentUser }) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Listing Section - CARD IDENTICHE A FEATUREDLISTINGS */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
        {filteredListings.length === 0 ? (
          <div className="text-center py-16">
            ...
            <button
              onClick={resetFilters}
              className="px-6 py-3 text-sm font-semibold text-white rounded-xl transition-colors shadow-md"
              style={{ backgroundColor: '#FFD93D', color: '#333' }}
            >
              Reset filtri
            </button>
              ...
              return (
                ...
                >
                  <div className="relative h-[140px] sm:h-[160px] overflow-hidden">
                    ...
                    {/* FavoriteButton placeholder - aggiungi import se serve */}
                    <div className="absolute top-2 right-2 w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-sm cursor-pointer hover:bg-white transition-colors">
