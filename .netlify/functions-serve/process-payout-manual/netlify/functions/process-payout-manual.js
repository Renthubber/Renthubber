...
// netlify/functions/process-payout-manual.ts
var process_payout_manual_exports = {};
__export(process_payout_manual_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(process_payout_manual_exports);
...
var handler = async (event, context) => {
  ...
  try {
    ...
    if (!payoutRequestId || !adminId || approved === void 0) {
      return {
        statusCode: 400,
        headers,
    ...
    console.log("\u{1F4B0} Processing payout request:", {
      payoutRequestId,
      approved,
      adminId
    });
    ...
    console.log("\u{1F389} Payout processed successfully");
    return {
      statusCode: 200,
      headers,
      body: JSON.stringify({
...
//# sourceMappingURL=process-payout-manual.js.map
