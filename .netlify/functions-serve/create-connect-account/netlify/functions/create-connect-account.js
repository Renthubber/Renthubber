...
// netlify/functions/create-connect-account.ts
var create_connect_account_exports = {};
__export(create_connect_account_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(create_connect_account_exports);
...
var handler = async (event, context) => {
  ...
  try {
    ...
    console.log("\u{1F680} Creating Stripe Connect Account for user:", userId);
...
//# sourceMappingURL=create-connect-account.js.map
