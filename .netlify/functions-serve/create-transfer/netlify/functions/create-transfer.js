...
// netlify/functions/create-transfer.ts
var create_transfer_exports = {};
__export(create_transfer_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(create_transfer_exports);
...
var handler = async (event, context) => {
  ...
  try {
    ...
    console.log("\u{1F4B8} Creating transfer for booking:", bookingId);
    ...
    console.log("\u{1F4B0} Transfer amount:", hubberNetAmount, "\u20AC");
    ...
    await fetch(
      `${SUPABASE_URL}/rest/v1/bookings?id=eq.${bookingId}`,
      {
        ...
        body: JSON.stringify({
          ...
          transfer_completed_at: (/* @__PURE__ */ new Date()).toISOString()
        })
      }
    );
    ...
    console.log("\u{1F389} Transfer completed successfully");
    return {
      statusCode: 200,
      headers,
      body: JSON.stringify({
...
//# sourceMappingURL=create-transfer.js.map
