...
// netlify/functions/modify-booking-payment.ts
var modify_booking_payment_exports = {};
__export(modify_booking_payment_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(modify_booking_payment_exports);
...
var ApiVersion = "2025-11-17.clover";
...
// utils/feeUtils.ts
function calculateRenterFixedFee(amount) {
  return amount <= 8 ? 0.5 : 2;
}
...
var handler = async (event, context) => {
  ...
  try {
    ...
    console.log("\u{1F504} Modify Booking Request:", {
      bookingId,
      renterId,
      newStartDate,
      newEndDate,
    ...
    let originalDays = Math.max(Math.ceil(originalDiffTime / (1e3 * 60 * 60 * 24)), 1);
    const newStart = new Date(newStartDate);
    const newEnd = new Date(newEndDate);
    const newDiffTime = Math.abs(newEnd.getTime() - newStart.getTime());
    let newDays = Math.max(Math.ceil(newDiffTime / (1e3 * 60 * 60 * 24)), 1);
    ...
    console.log("\u{1F4B0} Price calculation:", {
      originalDays,
      newDays,
    ...
    if (priceDifference < 0) {
      ...
      console.log("\u{1F4B8} Refund scenario:", refundAmount.toFixed(2));
      ...
      console.log("\u{1F4B8} Refund breakdown:", {
    ...
    console.log("\u{1F4B3} Supplement scenario:", priceDifference.toFixed(2));
    if (!paymentMethod) {
      return {
        statusCode: 400,
        headers,
    ...
    if (paymentMethod === "wallet") {
      console.log("\u{1F4B0} Paying with wallet...");
      ...
      console.log("\u{1F4DD} Creating renter transaction:", {
        renterId,
        priceDifference,
      ...
      console.log("\u{1F4DD} Transaction response:", {
    ...
    if (paymentMethod === "card") {
      console.log("\u{1F4B3} Creating Payment Intent for card...");
...
//# sourceMappingURL=modify-booking-payment.js.map
