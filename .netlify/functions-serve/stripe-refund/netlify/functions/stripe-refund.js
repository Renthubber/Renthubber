...
// netlify/functions/stripe-refund.ts
var stripe_refund_exports = {};
__export(stripe_refund_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(stripe_refund_exports);
...
var handler = async (event, context) => {
  ...
  try {
    ...
    console.log("\u{1F4B3} Creating refund:", {
      paymentIntentId,
...
//# sourceMappingURL=stripe-refund.js.map
