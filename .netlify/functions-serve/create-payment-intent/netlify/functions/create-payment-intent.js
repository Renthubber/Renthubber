...
var handler = async (event, context) => {
  ...
  try {
    ...
    console.log("\u{1F4B3} Creating Payment Intent:", {
      renterId,
      listingId,
      totalAmount,
      generalBalanceToUse,
    ...
    console.log("\u{1F4B0} Current balances:", {
      generalBalance,
      refundBalance,
      referralBalance
    });
    ...
    console.log("\u{1F4B0} Wallet calculation:", {
      totalAmount,
      generalBalanceToUse,
      refundBalanceToUse,
      referralBalanceToUse,
    ...
    if (amountToPayCents === 0) {
      ...
      console.log("\u{1F4DD} Booking response status:", bookingResponse.status);
      ...
      console.log("\u{1F4DD} Booking result:", JSON.stringify(bookingResult));
      ...
      console.log("\u{1F4B0} Updating wallet balances:", {
      ...
      console.log(`\u{1F4B3} Creating ${transactions.length} wallet transactions...`);
