  ...
  try {
    ...
    if (amountToPayCents === 0) {
      ...
      const bookingData = {
        ...
        hubber_net_amount: basePrice + cleaningFee + extraGuestsFee - hubberFee,
      ...
      const bookingResponse = await fetch(
        `${SUPABASE_URL}/rest/v1/rpc/create_booking_with_payment`,
        {
          ...
          body: JSON.stringify({
            ...
            p_hubber_net_amount_cents: Math.round((basePrice + cleaningFee + extraGuestsFee - hubberFee) * 100),
